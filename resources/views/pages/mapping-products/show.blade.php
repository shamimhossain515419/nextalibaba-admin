        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex flex-col justify-between gap-5 border-b border-gray-200 px-5 py-4 sm:flex-row sm:items-center dark:border-gray-800">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('mapping.product.create') }}"
                            ...
                            <td class="px-5 py-4 whitespace-nowrap">
                                <div class="relative flex justify-center">
                                    ...
                                    <div class="dropdown-menu shadow-theme-lg fixed w-40 space-y-1 rounded-2xl border border-gray-200 bg-white p-2 dark:border-gray-800 dark:bg-gray-800" style="display: none;">
                                        <a href="{{ route('mapping.product.edit', $item->id) }}"
                                        ...
                                        <form action="{{ route('mapping.product.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Features category?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-5 py-8 text-center">
                                <p class="text-sm text-gray-500 dark:text-gray-400">No Mapping Product found.</p>
                            </td>
                        </tr>
                    @endforelse
                    </tbody>
