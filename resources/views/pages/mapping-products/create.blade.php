...
@section('content')
  <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
    ...
    <form action="{{ route('mapping.product.store') }}" method="POST" enctype="multipart/form-data">
     @csrf
      ...
      <div class="space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
          <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
            <h2 class="text-lg font-medium text-gray-800 dark:text-white">Mapping Products Description</h2>
          </div>
