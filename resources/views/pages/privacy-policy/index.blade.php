...
@section('content')
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        ...
        {{-- FORM --}}
        <form action="{{ route('privacyPolicy.store') }}" method="POST" enctype="multipart/form-data" id="itemForm">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-2xl border bg-white p-6 dark:bg-white/[0.03]">
                    ...
                    {{-- Description (Quill) --}}
                    <div class="mb-4">
                        <label class="block text-sm font-medium mb-1">Privacy policy Description</label>
                ...
                <div class="flex justify-end">
                    <button class="rounded-lg bg-blue-500 px-6 py-3 text-white">
                        {{ $data ? 'Update Privacy policy' : 'Create Privacy policy' }}
                    </button>
                </div>
