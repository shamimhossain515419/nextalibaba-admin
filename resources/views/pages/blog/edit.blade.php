            ...
            <div class="space-y-6">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="p-4 sm:p-6 dark:border-gray-800">
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                            ...
                            <div x-data="{ switcherToggle: {{ $blog->status ? 'true' : 'false' }} }">
                                <label for="toggle2" class="flex cursor-pointer items-center gap-3 text-sm font-medium text-gray-700 select-none dark:text-gray-400">
                                    <div class="relative">
                                        <input type="checkbox" name="status" id="toggle2" class="sr-only"
                                               {{ $blog->status ? 'checked' : '' }}
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        @if($blog->image)
                            <div class="mb-4">
                                <p class="text-sm font-medium text-gray-700 dark:text-gray-400 mb-2">Current Image:</p>
                                <div class="relative inline-block">
                                    <img src="{{ asset('storage/'.$blog->image) }}" alt="Current blog image"
                                         class="w-full max-w-md h-auto max-h-64 object-contain rounded-lg border border-gray-300 dark:border-gray-700">
                                </div>
                            </div>
                        @endif
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                    <a href="{{ route('blogs.index') }}"
                       class="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">
                        Cancel
                    </a>
                    <button type="submit"
