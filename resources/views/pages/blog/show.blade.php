                ...
                <table class="w-full table-auto">
                    ...
                    @forelse($blogs as $item)
                        <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900 category-row">
                            ...
                            <td class="px-5 py-4 whitespace-nowrap">
                                <p class="text-sm text-gray-700 dark:text-gray-400">{{$item->stock}}</p>
                            </td>
                            <td class="px-5 py-4 whitespace-nowrap">
                                <p class="text-sm text-gray-700 dark:text-gray-400">{{$item->base_price}}</p>
                            </td>
                            ...
                            <td class="px-5 py-4 whitespace-nowrap">
                                <div class="relative flex justify-center">
                                    ...
                                    <div
                                        class="dropdown-menu shadow-theme-lg fixed w-40 space-y-1 rounded-2xl border border-gray-200 bg-white p-2 dark:border-gray-800 dark:bg-gray-800"
                                        style="display: none;">
                                        <a href="{{ route('inventory.product.edit', $item->id) }}"
                                        ...
                                        <form action="{{ route('inventory.product.destroy', $item->id) }}"
                                              method="POST"
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-5 py-8 text-center">
                                <p class="text-sm text-gray-500 dark:text-gray-400">No blogs found.</p>
                            </td>
                        </tr>
                    @endforelse
                    </tbody>
